/**
 * Tool registry for Romanian Law MCP Server.
...
import { getRomanianImplementations, type GetRomanianImplementationsInput } from './get-romanian-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including the Legislatie.just.ro (Romanian Government, Office of Parliamentary Counsel). ' +
    ...
    'Call this FIRST when you need to understand what Romanian legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Romanian statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section) from an Romanian statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate an Romanian legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Format an Romanian legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether an Romanian statute or provision is currently in force, amended, repealed, or not yet in force. ' +
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Romanian statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_romanian_implementations',
    description:
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that are referenced by Romanian legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_romanian_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents referenced by Romanian legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU legal basis for a SPECIFIC provision within an Romanian statute. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_romanian_implementations':
          result = await getRomanianImplementations(db, args as unknown as GetRomanianImplementationsInput);
          break;
