...
**Endpoint:** `https://mcp.ansvar.eu/law-ro/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add romanian-law --transport http https://mcp.ansvar.eu/law-ro/mcp` |
...
```json
{
  "mcpServers": {
    "romanian-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-ro/mcp"
    }
  }
}
```
