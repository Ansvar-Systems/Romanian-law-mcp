...
- **No Attorney-Client Relationship**: Use of this Tool does not create an attorney-client relationship (contract de asistență juridică)
...
- **Malpractice Risk**: Relying on unverified information from this Tool in professional legal work may constitute professional malpractice (răspundere profesională)
...
- **Professional Rules**: Members of the Union of Romanian Bar Associations (Uniunea Națională a Barourilor din România — UNBR) must comply with the Statutul profesiei de avocat and applicable professional conduct rules when using AI tools
...
1. Checking the official source (Portal Legislativ — legislatie.just.ro or Monitorul Oficial — monitoruloficial.ro)
2. Verifying the provision is currently in force (în vigoare) and has not been amended (modificat)
3. Reading the full context of cited provisions
4. Consulting case law (jurisprudență) and explanatory materials (expuneri de motive) for interpretation
...
This Tool aggregates data from official Romanian legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **legislatie.just.ro (Portal Legislativ)** | Authoritative | Statute text, codified legislation (primary reference) |
| **monitoruloficial.ro (Monitorul Oficial)** | Authoritative | Official gazette, original publication |
...
- Lege5 (lege5.ro), Indaco, Sintact

These services provide editorial oversight, comprehensive annotations (comentarii), and professional-grade currency guarantees that this Tool **cannot** provide.
...
- Romanian law changes continuously through new statutes (legi), amendments (modificări), and court decisions (hotărâri judecătorești)
...
- Even "fresh" data may be outdated if recent amendments were published in the Monitorul Oficial al României
- Staleness warnings do not guarantee completeness or accuracy
- Always check official sources for the current legal position (situația actuală a normei juridice)

### Amendments and Repeals

- A provision marked "in force" may have been:
  - Amended (modificat) after the last database update
  - Repealed (abrogat) but not yet removed from the database
  - Subject to transitional rules (dispoziții tranzitorii) affecting its applicability
...
1. **Complete case law** -- Coverage of the High Court of Cassation and Justice (Înalta Curte de Casație și Justiție — ICCJ), Constitutional Court (Curtea Constituțională), and lower court decisions is limited
2. **Historical statute versions** -- Limited availability of historical provision wording (istoricul modificărilor)
3. **Legal commentary** -- No editorial annotations (note de subsol), academic commentary (doctrină), or practice guides
4. **Unpublished decisions** -- Administrative rulings largely absent
5. **Full legislative history** -- Limited coverage of parliamentary materials (expuneri de motive, rapoarte de comisie)
...
- **EU Law Blind Spots**: Cannot fully assess EU law obligations or treaty compliance
...
- This includes but is not limited to:
  - Professional malpractice claims (acțiuni în răspundere profesională)
  - Lost cases or adverse judgments
  - Client harm from erroneous advice
  - Regulatory sanctions from bar authorities (sancțiuni disciplinare)
  - Reputational damage
...
- **Sensitive Matters**: For privileged legal matters (secretul profesional al avocatului), consider on-premise deployment

### Competence and Diligence

Using this Tool does not reduce your professional obligations to:

- Exercise independent legal judgment (apreciere independentă)
- Conduct thorough legal research using authoritative sources
- Stay current with legal developments
- Provide competent representation (asistență juridică competentă)

## Recommended Workflow for Professional Use

1. **Initial Research**: Use Tool for preliminary research and hypothesis generation
2. **Official Verification**: Cross-check ALL results with official sources (legislatie.just.ro, Monitorul Oficial)
3. **Commercial Databases**: Use professional legal databases (Lege5, Indaco, Sintact) for authoritative, annotated versions
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Romanian-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Romanian-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (legislatie.just.ro, Monitorul Oficial)
...
- **COMPLY** with UNBR Statutul profesiei de avocat and professional ethics rules regarding AI tool use and client confidentiality
